...
public interface IFileTrackingService
{
    ...
    Task<bool> UpdateStatusAsync(string sourceFile, string? destFile, MediaType? mediaType, int? tmdbId, string? imdbId, IEnumerable<string>? genres = null, FileStatus? status = null);
    Task<bool> UpdateStatusAsync(string sourceFile, string? destFile, MediaType? mediaType, int? tmdbId, string? imdbId, int? seasonNumber, int? episodeNumber, IEnumerable<string>? genres = null, FileStatus? status = null);
