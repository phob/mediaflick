...
export default function Stats() {
  ...
  useEffect(() => {
    ...
    const unsubscribeAdd = signalr.subscribe("OnFileAdded", invalidateStats)
    const unsubscribeUpdate = signalr.subscribe("OnFileUpdated", invalidateStats)
    const unsubscribeRemove = signalr.subscribe("OnFileRemoved", invalidateStats)
